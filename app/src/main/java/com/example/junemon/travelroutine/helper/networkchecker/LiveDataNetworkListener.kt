...
class LiveDataNetworkListener(val ctx: Context) : LiveData<Boolean>() {
    ...
    class NetworkCallback(val liveData: LiveDataNetworkListener) : ConnectivityManager.NetworkCallback() {
